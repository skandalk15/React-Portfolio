    ...
    ref={ref}
      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
           ...
           href='https://drive.google.com/file/d/1r8fjLqmgAixZv5F8SiGfLNs2TcDEQVd_/view?usp=sharing' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
