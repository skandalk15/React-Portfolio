    ...
    ref={ref}
      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
           ...
           href='https://drive.google.com/file/d/15Z3akHfIt4bmhFbYn8ZMSxDQwtfDHjYO' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
