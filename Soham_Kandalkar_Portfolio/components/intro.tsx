    ...
    ref={ref}
      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
           ...
           href='https://drive.google.com/drive/folders/1knKGHOur5iKISELWcwYgx9b_xgI2MyDC?dmr=1&ec=wgc-drive-globalnav-goto' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
